      ...
      <div className={styles.container}>
        <div className={styles.center}>
          ...
          <div className={styles.padding}>
            <p>This policy applies to Jeremy Carmona{"'"}s Web site only. It is designed to inform you of how and why Jeremy Carmona gathers personal and non-personal information about you. This policy complies with provisions of the British Columbia Freedom of Information and Protection of Privacy Act.</p>
            ...
            <p>Jeremy Carmona may collect the following non-identifiable information when you visit this Web site:</p>
            ...
            <p>By visiting this Web site and voluntarily providing personal information to Jeremy Carmona{"'"}s Web site, you agree to the terms of this online User Agreement and the Privacy Policy contained herein. However, We welcome your comments and/or suggestions on improving this Web site and policies.</p>
