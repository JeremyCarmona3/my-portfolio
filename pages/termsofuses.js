      ...
      <div className={styles.container}>
        ...
        <div>
          ...
          <p>
            ...
            not modify, publish, transmit, transfer, sell, reproduce, re-post or
            alter any such content. Jeremy Carmona hereby grants you a personal,
            non-exclusive, non-assignable and non-transferable license to use
            and display, for home, non-commercial and personal use only, one
            copy of any content that you may download from this Web site. Any
            other use or reproduction of this Web site, in whole or in part,
            will be considered to be a violation of Jeremy Carmona
          ...
          <p>
            ...
            Carmona reserves the right to modify, alter or otherwise update this
