      ...
      <div className={styles.container}>
        <div className={styles.center}>
          ...
          <div className={styles.padding}>
            ...
            <p>All content and information (including, but not limited to, code, graphics, photos, guides, promotional materials, press releases, articles, plans, schedules, illustrations, audio clips, and video clips) displayed on this Web site is owned or licensed by Jeremy Carmona and its respective owners, all content on this site is protected by copyright and other intellectual property laws. Any names, titles, logos and designs displayed on the Web site that contain Jeremy Carmona, titles, logos, or brands are the exclusive property and trademarks of Jeremy Carmona or its members. You may not modify, publish, transmit, transfer, sell, reproduce, re-post or alter any such content. Jeremy Carmona hereby grants you a personal, non-exclusive, non-assignable and non-transferable license to use and display, for home, non-commercial and personal use only, one copy of any content that you may download from this Web site. Any other use or reproduction of this Web site, in whole or in part, will be considered to be a violation of Jeremy Carmona{"'"}s intellectual property rights.</p>
            <p>Your use of this Web site constitutes your agreement to abide by these terms of use included in this online User Agreement. Jeremy Carmona reserves the right to modify, alter or otherwise update this User Agreement at any time.</p>
